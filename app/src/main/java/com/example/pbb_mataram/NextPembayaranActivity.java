...
public class NextPembayaranActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_pembayaran);
...
//        }
    ...
    private void run(){
        ...
        Call<SearchListModel> call = api.getPembayaran(nopX,"pbbm21");
