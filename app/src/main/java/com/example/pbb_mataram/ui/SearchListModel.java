...
import com.google.gson.annotations.SerializedName;
    ...
    class SearchItem {
        ...
        @Expose
        private Object paymentMerchantCode;
        @SerializedName("pbb_collectible")
        @Expose
        private Object pbbCollectible;
        ...
        @SerializedName("tarif_denda_pbb")
        @Expose
        private String tarifDendaPbb;
        @SerializedName("tarif_admin_pbb")
        @Expose
        private String tarifAdminPbb;
        @SerializedName("jumlah_bulan_denda")
        @Expose
        private Integer jumlahBulanDenda;
        ...
        public Object getWpKodepos() {
            return wpKodepos;
        }

        public void setWpKodepos(Object wpKodepos) {
        ...
        public Object getPaymentPaid() {
            return paymentPaid;
        }

        public void setPaymentPaid(Object paymentPaid) {
        ...
        public Object getPaymentBankCode() {
            return paymentBankCode;
        }

        public void setPaymentBankCode(Object paymentBankCode) {
        ...
        public Object getPaymentMerchantCode() {
            return paymentMerchantCode;
        }

        public void setPaymentMerchantCode(Object paymentMerchantCode) {
            this.paymentMerchantCode = paymentMerchantCode;
        }

        public Object getPbbCollectible() {
            return pbbCollectible;
        }

        public void setPbbCollectible(Object pbbCollectible) {
        ...
        public String getTarifDendaPbb() {
            return tarifDendaPbb;
        }

        public void setTarifDendaPbb(String tarifDendaPbb) {
            this.tarifDendaPbb = tarifDendaPbb;
        }

        public String getTarifAdminPbb() {
            return tarifAdminPbb;
        }

        public void setTarifAdminPbb(String tarifAdminPbb) {
            this.tarifAdminPbb = tarifAdminPbb;
        }

        public Integer getJumlahBulanDenda() {
            return jumlahBulanDenda;
        }

        public void setJumlahBulanDenda(Integer jumlahBulanDenda) {
            this.jumlahBulanDenda = jumlahBulanDenda;
        }
